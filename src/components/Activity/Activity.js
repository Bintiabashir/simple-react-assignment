...
const Activity = ({ handleAddToList, activity }) => {
    ...
    return (
        <div className='activity border-rose-100 bg-white border-2 rounded-lg relative'>
            ...
            <div className="px-3">
                <h4 className="text-center text-rose-700 text-medium font-semibold font-serif h-9 md:h-10 pb-1">{name}</h4>
                <p ><small className='text-rose-400 leading-2'>{about}</small></p>
                <h5 className='text-red-500 pt-1 sm:py-2'><span className=' font-medium'>For Age:</span> {age}</h5>
